    ...
    axum::Router::new()
        ...
        .nest(
            ...
            axum::Router::new()
                ...
                // )
                .route(
                    "/cat/{cat-name}/add-topics",
                    routing::put(link::cat::add_topics_bulk),
                )
                .route(
                    "/cat/{cat-name}/remove-topics",
                    routing::delete(link::cat::remove_topics_bulk),
                ),
        )
        .nest(
            "/-/ln/v1/api/",
            axum::Router::new()
                ...
                .route("/bm/{id}", routing::put(link::bookmark::update))
